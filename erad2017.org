...
** Note:
These commands were tested with the following emacs, org-mode and R
...
*** R (and libraries) version
#+begin_src R :results output :session R3 :exports both :var libs=load_libraries :eval no
sessionInfo()
#+end_src
...
other attached packages:
 [1] flexdashboard_0.2.0 knitr_1.13          gtable_0.2.0       
 [4] dtplyr_0.0.1        inline_0.3.14       Rcpp_0.12.7        
 [7] plotly_4.5.6        lpSolve_5.6.13      RColorBrewer_1.1-2 
[10] reshape_0.8.5       scales_0.4.1        gridExtra_2.2.1    
[13] data.table_1.9.6    gtools_3.5.0        ggplot2_2.2.1      
[16] dplyr_0.5.0         plyr_1.8.4         

loaded via a namespace (and not attached):
 [1] magrittr_1.5      munsell_0.4.3     viridisLite_0.1.3 colorspace_1.2-6 
 [5] R6_2.1.2          stringr_1.1.0     httr_1.2.1        tools_3.3.2      
 [9] DBI_0.4-1         htmltools_0.3.5   lazyeval_0.2.0    assertthat_0.1   
[13] digest_0.6.10     tibble_1.2        tidyr_0.6.0       purrr_0.2.2      
[17] base64enc_0.1-3   htmlwidgets_0.7   evaluate_0.9      rmarkdown_1.0    
[21] stringi_1.1.2     jsonlite_1.1      chron_2.3-47
#+end_example
...
\author{Vinícius Garcia Pinto\inst{1, 2}\thanks{Este trabalho foi parcialmente 
financiado por recursos do projeto HPC4E (http://www.hpc4e.eu), financiamento 689772 do 
acordo internacional entre o programa H2020-EU e o MCTI/RNP-Brasil.}, Lucas Mello 
Schnorr\inst{1}, Arnaud Legrand\inst{2}}
\vspace{-0.3cm}
\address{Instituto de Informática - Universidade Federal do Rio Grande do Sul - Brasil
\nextinstitute
