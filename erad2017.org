...
traços de execução obtidos previamente. Estes traços são carregados a
...
básico de Gantt representando a execução. Por meio de uma estratégia
...
visualizar outras informações inferidas do traço tais como a
...
A Figura \ref{fig:ganttDep} apresenta um diagrama de Gantt obtido
com o /framework/ proposto a partir do traço da execução de uma
...
processamento do traço e geração da Figura \ref{fig:ganttDep}, bem como uma versão
